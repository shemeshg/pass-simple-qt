...
mkdir deployed
cd deployed
call D:\Qt\6.9.1\msvc2022_64\bin\qt-cmake -GNinja -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=. D:\projects\pass-simple-qt
call ninja

rmdir /s/q R:\WinDll
mkdir R:\WinDll
copy R:\deployed\src\rnp\*.dll R:\WinDll
copy D:\projects\pass-simple-qt\icon.ico R:\WinDll
