...
class DropdownWithListType : public QObject
{
  ...
  Q_PROPERTY(QStringList selectedItems READ selectedItems WRITE setSelectedItems NOTIFY selectedItemsChanged)
  Q_PROPERTY(QStringList notSelectedItems READ notSelectedItems WRITE setNotSelectedItems NOTIFY notSelectedItemsChanged)
  // hygen Q_PROPERTY
  QML_ELEMENT
